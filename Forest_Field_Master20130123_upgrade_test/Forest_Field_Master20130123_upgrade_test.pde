...
float volG;//This is the amplitude (functionally volume) used in the G synthesizer
float volC;//This is the amplitude (functionally volume) used in the C synthesizer
float volF;//This is the amplitude (functionally volume) used in the F synthesizer
...
//**MAIN HEADER-------------AUDIO------------**\\
  ...
  sineG = new SineWave(100, vol, out.sampleRate());//1st sine wave - frequency between G and an A
  sineC = new SineWave(270, vol, out.sampleRate());//2nd sine wave - frequency between C and D
  sineF = new SineWave(175, vol, out.sampleRate());//3rd sine wave - frequency ~F
