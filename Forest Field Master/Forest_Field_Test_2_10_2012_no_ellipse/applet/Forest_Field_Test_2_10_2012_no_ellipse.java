...
public class Forest_Field_Test_2_10_2012_no_ellipse extends PApplet {
...
public void branch(float h) {
  ...
  if (h > 2) {
    ...
    rotate(theta*PI/8);   // Rotate by theta
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "Forest_Field_Test_2_10_2012_no_ellipse" });
  }
}
