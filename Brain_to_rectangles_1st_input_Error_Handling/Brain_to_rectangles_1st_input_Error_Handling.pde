...
if(v>=1){
  ...
  fill(45);  text(count, x, 60);
  fill(87);  //text(data[0], x, 95);
 
  fill(97);  rect(100,145,v,15);
   fill(204);   text(data[0], x, 165);  fill(97);
  rect(100,185,w,15);   fill(204);text(data[1], x, 200);
  fill(97);  rect(100,240,z,15);
//delay(100000);
   fill(204);text(data[2],x,255);  fill(255);
  //text("shi", x, 185); }
  }}catch(Exception e){
    ;
  }
