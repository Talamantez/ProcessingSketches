...
public class Forest_Field_Master20130123_4_notes extends PApplet {
...
// Draw the lines. If the pixel size is smaller than 2, stop the recursive branching
  if (h > 2) {
    ...
    popMatrix();     // Return to the original screen reference point
    strokeWeight(sw); //set the strokeWeight to sw
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--hide-stop", "Forest_Field_Master20130123_4_notes" });
  }
}
